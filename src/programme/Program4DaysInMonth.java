...
public class Program4DaysInMonth {
     ...
     * Write a method isLeapYear with a parameter of type int named year. The parameter needs
     * to be greater than or equal to 1 and less than or equal to 9999. If the parameter is not in
     * that range return false. Otherwise, if it is in the valid range, calculate if the year is
     * a leap year and return true if it is, otherwise return false. A year is a leap year if it
     * is divisible by 4 but not by 100, or it is divisible by 400. Example of input/Output:
     ...
     * have 29 days in month 2 (February). You should check if the year is a leap year using the method isLeapYear describe above.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDaysInMonths(2,2024));
        System.out.println(getDaysInMonths(2,2019));
        System.out.println(getDaysInMonths(4,2022));
        System.out.println(getDaysInMonths(13,2022));
